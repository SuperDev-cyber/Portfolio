    ...
    <div>
      ...
      <div className="hero-section">
        <div className="hero-content">
          ...
          >
            <TypingEffect text="Hi, I'm Jackson Franklin." speed={200} loop={true} />
          </motion.h1>
          ...
          >
            <a
              href="https://drive.google.com/file/d/1vuGoTDICKlAsiZZ9zNkrM4d0zWuZJhfQ/view"
              target="_blank"
            ...
            <a href="mailto:jackson19990427@gmail.com" className="contact-link shine-button">
              Mail Me
            </a>
          </motion.div>
        </div>
